...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        binding.btnLaunchGallery.setOnClickListener {
            ...
            if (viewModel.premiumUnlocked.value) {
                ...
                // Initialize AdMob
                com.salmanlaghari.spelltypekeyboard.presentation.ads.AdManager.init(this)
                ...
                com.salmanlaghari.spelltypekeyboard.presentation.ads.AdManager.loadInterstitial(
                    context = this,
                    type = com.salmanlaghari.spelltypekeyboard.presentation.ads.InterstitialType.SETTINGS,
    ...
    private fun loadSettingsNativeAd() {
        try {
            com.salmanlaghari.spelltypekeyboard.presentation.ads.AdManager.init(this)
            com.salmanlaghari.spelltypekeyboard.presentation.ads.AdManager.loadNativeAd(
                context = this,
                onLoaded = { nativeAd ->
